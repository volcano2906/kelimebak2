...
def optimize_keyword_placement(keyword_list):
    ...
    field3, points3, used_kw3, length3 = fill_field_with_word_breaking(
    100,  # Field limit (100 characters for Field 3)
    sorted_keywords,  # The keyword list sorted by points
